    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, CategoryId = 2, Name = "Kitap 1", Price = 150, Stock = 10, CreatedDate = DateTime.Now },
                new Product { Id = 5, CategoryId = 2, Name = "Kitap 2", Price = 700, Stock = 40, CreatedDate = DateTime.Now });
        }
    }
}
